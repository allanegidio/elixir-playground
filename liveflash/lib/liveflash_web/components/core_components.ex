defmodule LiveflashWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveflashWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveflashWeb.Gettext, "errors", msg, opts)
    end
  end
